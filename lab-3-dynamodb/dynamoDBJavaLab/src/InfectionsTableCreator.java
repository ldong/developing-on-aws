...
//	  dynamoDB.createTable(tableName,(List<KeySchemaElement>) tableKeySchemaElem, attributeDefinitions, tableProvisionedThroughput);
	  CreateTableRequest tableRequest = new CreateTableRequest();
	  tableRequest.withTableName(tableName);
	  tableRequest.withKeySchema(tableKeySchemaElem);
	  tableRequest.withAttributeDefinitions(attributeDefinitions);
	  tableRequest.withProvisionedThroughput(tableProvisionedThroughput);
	  tableRequest.withGlobalSecondaryIndexes(gsi);
