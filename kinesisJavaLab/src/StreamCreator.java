...
public class StreamCreator {
  ...
  public static final String STREAM_NAME = "kinesis-lab-stream-123123";
...
//    return Solution.createKinesisClient(credentials, REGION);
	  ...
	  return new AmazonKinesisClient(credentials).withRegion(REGION);
  }
...
//    return Solution.getStreamStatus(kinesis, streamName);
	DescribeStreamResult describeStreamResponse = kinesis.describeStream(streamName);
	String streamStatus = describeStreamResponse.getStreamDescription().getStreamStatus();
	System.out.println("streamStatus " + streamStatus);
    return streamStatus;
  }
}
