...
public class DataTransformer {
  ...
  public static final String INPUT_BUCKET_NAME = "aws-training-developing-on-aws-mar-27-2018-input";

  // STUDENT TODO 2: Set output bucket name (must be globally unique)
  public static final String OUTPUT_BUCKET_NAME = "aws-training-developing-on-aws-mar-27-2018-output";
...
//        s3ClientForStudentBuckets, OUTPUT_BUCKET_NAME, fileKey, transformedFile);
  ...
  private static URL generatePresignedUrl(String bucketName, String objectKey) {
    ...
    Date date = new Date();
	try {
		date = parseFormat.parse("2018-03-28T00:00:00.000-0500");
	} catch (ParseException e) {
		// TODO Auto-generated catch block
		e.printStackTrace();
	}
	return s3ClientForStudentBuckets.generatePresignedUrl(bucketName, objectKey, date);
...
//	              https://docs.aws.amazon.com/AmazonS3/latest/dev/SSEUsingJavaSDK.html
	  ...
	  objectMetadata.addUserMetadata("Name", "Alan");
	  objectMetadata.addUserMetadata("Date", "3/27/2018");
