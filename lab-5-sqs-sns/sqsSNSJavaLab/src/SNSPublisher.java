...
//  EmailSNSTopic
  ...
  private static final String TOPIC_ARN_EMAIL = "arn:aws:sns:us-west-2:051013433789:EmailSNSTopic";

//  OrderSNSTopic
  // STUDENT TODO 2: Set ARN for SNS topic for order messages
  private static final String TOPIC_ARN_ORDER = "arn:aws:sns:us-west-2:051013433789:OrderSNSTopic";
...
//    return Solution.convertOrderToJSON(mapper, order);
	...
	try {
		jsonFormatString = mapper.writeValueAsString(order);
