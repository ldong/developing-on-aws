...
public class CacheManager {
  ...
  public static final String CLUSTER_CONFIG_ENDPOINT = "qls-el-5rnylshthq40.vdambo.0001.usw2.cache.amazonaws.com";
 ...
 * @throws IOException 
   */
  private static MemcachedClient newMemcachedClient() throws IOException {
...
//    return Solution.newMemcachedClient(CLUSTER_CONFIG_ENDPOINT, CLUSTER_CONFIG_ENDPOINT_PORT);
	  MemcachedClient client = new MemcachedClient(
              new InetSocketAddress(CLUSTER_CONFIG_ENDPOINT, 
            		  CLUSTER_CONFIG_ENDPOINT_PORT));
	  return client;
  }
